            ...
            LanguageType.CHINESE: r"""
                <instructions>
                    ...
                    <example>
                        <conversation>
                            <user>杭州西湖有哪些景点？</user>
                            <assistant>杭州西湖是中国浙江省杭州市的一个著名景点，以其美丽的自然风光和丰富的文化遗产而闻名。\
西湖周围有许多著名的景点，包括著名的苏堤、白堤、断桥、三潭印月等。西湖以其清澈的湖水和周围的山脉而著名，是中国最著名的湖泊之一。</assistant>
                        </conversation>
            ...
            LanguageType.ENGLISH: r"""
                <instructions>
                    <instruction>
                        Extract key information from the conversation and organize it into unique, easily \
understandable facts that include user preferences, relationships, entities, etc.
                        The following are the types of information to be paid attention to and detailed instructions \
on how to handle the input data.

                        **Types of information to be paid attention to**
                        1. Entities: Entities involved in the conversation. For example: names, locations, \
organizations, events, etc.
                        2. Preferences: Attitudes towards entities. For example: like, dislike, etc.
                        3. Relationships: Relationships between the user and entities, or between two entities. \
For example: include, parallel, exclusive, etc.
                        4. Actions: Specific actions that affect entities. For example: query, search, browse, \
click, etc.

                        **Requirements**
                        1. Facts must be accurate and can only be extracted from the conversation. Do not include \
information from the sample in the output.
                    ...
                    <example>
                        <conversation>
                            ...
                            <assistant>West Lake in Hangzhou is a famous scenic spot in Hangzhou, Zhejiang Province, \
China, famous for its beautiful natural scenery and rich cultural heritage. There are many famous attractions around \
West Lake, including the famous Su Causeway, Bai Causeway, Broken Bridge, Three Pools Mirroring the Moon, etc. West \
Lake is famous for its clear water and surrounding mountains, and is one of the most famous lakes in China. </assistant>
                        </conversation>

                        <output>
                            {{
                                "facts": ["West Lake has the famous attractions of Suzhou Embankment, Bai Embankment, \
Qiantang Bridge, San Tang Yin Yue, etc."]
                            }}
                        </output>
                    </example>
                </instructions>
