...
SLOT_GEN_PROMPT: dict[LanguageType, str] = {
    ...
    <instructions>
        You are an AI assistant capable of using tools to complete tasks.
            ...
            Please generate a compliant JSON object based on user input, background information, tool information, \
and JSON Schema content.

            Background information will be provided in <context>, tool information in <tool_info>, JSON Schema in \
<tool_call>, and the user's question in <question>.
            ...
            2. Prioritize using values from user input for JSON fields. If not available, use content from background \
information.
        ...
        <example>
            <context>
                User asked about today's weather in Hangzhou. AI replied it's sunny, 20℃. User then asks about \
tomorrow's weather in Hangzhou.
            </context>
            <question>
